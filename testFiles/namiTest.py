...
products = [9982687346980, 9386575069476, 10087083442468, 10038606201124, 9476250730788]
rockysProductsUrl = "https://namimatcha.com/products.json"
...
for product_id in products:
    ...
    if product:
        ...
        if handle != 'N/A':
            url = f"https://namimatcha.com/products/{handle}"
            print(f"URL: {url}")
